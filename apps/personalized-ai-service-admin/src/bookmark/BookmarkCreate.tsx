...
export const BookmarkCreate = (props: CreateProps): React.ReactElement => {
  return (
    <Create {...props}>
      <SimpleForm>
        <DateTimeInput label="addDate" source="addDate" />
        <TextInput label="AI | Figure" source="aiFigure" />
        <TextInput
          label="AI-Powered Book Recommendations | BookSurfAI"
          source="aiPoweredBookRecommendationsBookSurfAi"
        />
        <TextInput label="AI_Scientist" source="aiScientist" />
        <TextInput label="AllAPI" source="allApi" />
        <TextInput
        ...
        />
        <TextInput label="arxiv" source="arxiv" />
        <TextInput
        ...
        />
        <TextInput label="BookSurfAI" source="bookSurfAi" />
        <TextInput label="Brainybear" source="brainybear" />
        <TextInput label="Careercompanion" source="careercompanion" />
        <TextInput label="china-inflatable" source="chinaInflatable" />
        <TextInput label="compareaimodels" source="compareaimodels" />
        <TextInput label="Connected_Papers" source="connectedPapers" />
        <TextInput
        ...
        />
        <TextInput label="DagsHub" source="dagsHub" />
        <TextInput label="Dashboard" source="dashboard" />
        <TextInput
          label="Dashboard | Speechmatics"
          source="dashboardSpeechmatics"
        />
        <TextInput label="DeepAI" source="deepAi" />
        <TextInput label="DeepSeek_Coder" source="deepSeekCoder" />
        <TextInput label="Deepgram" source="deepgram" />
        <TextInput label="deeplearning.ai" source="deeplearningAi" />
        <TextInput
        ...
        />
        <TextInput label="Demo-WithUI" source="demoWithUi" />
        <TextInput label="diplomatie" source="diplomatie" />
        <TextInput
        ...
        />
        <TextInput label="figure.ai" source="figureAi" />
        <TextInput label="Find a remote AI job" source="findARemoteAiJob" />
        <TextInput label="FLUX1_schnell" source="flux1Schnell" />
        <TextInput
          label="Free Transcription Tool | Deepgram"
          source="freeTranscriptionToolDeepgram"
        />
        <TextInput label="hCaptcha" source="hCaptcha" />
        <TextInput label="hCaptcha | Dashboard" source="hCaptchaDashboard" />
        <TextInput label="Home | Substack" source="homeSubstack" />
        ...
        />
        <TextInput label="interview_generator" source="interviewGenerator" />
        <TextInput
          label="Interview Question Generator"
          source="interviewQuestionGenerator"
        />
        <TextInput label="JumpCloud" source="jumpCloud" />
        <TextInput label="lab2" source="lab2" />
        <TextInput
          label="lab2 - AI generated data apps"
          source="lab2AiGeneratedDataApps"
        />
        <TextInput label="learnopal_flashcards" source="learnopalFlashcards" />
        <TextInput
          label="lidar_sensor_excavator_Google_Search"
          source="lidarSensorExcavatorGoogleSearch"
        />
        <TextInput label="massistant" source="massistant" />
        <TextInput
        ...
        />
        <TextInput label="mindsmith" source="mindsmith" />
        <TextInput
        ...
        />
        <TextInput label="multion.ai" source="multionAi" />
        <TextInput label="Napkin_AI" source="napkinAi" />
        <TextInput label="navigation" source="navigation" />
        <TextInput label="Nebius_AI" source="nebiusAi" />
        <TextInput
        ...
        />
        <TextInput label="PolygrAI" source="polygrAi" />
        <TextInput
        ...
        />
        <TextInput label="Quick Start" source="quickStart" />
        <TextInput label="sakana.ai" source="sakanaAi" />
        <TextInput label="SakanaAI_AI_Scientist" source="sakanaAiAiScientist" />
        <TextInput
        ...
        />
        <TextInput label="ScanDocFlow" source="scanDocFlow" />
        <TextInput label="Sign in - Napkin AI" source="signInNapkinAi" />
        <TextInput label="Signup | JumpCloud" source="signupJumpCloud" />
        <TextInput
          label="Start Here 🚀 Tutorial Lesson"
          source="startHereTutorialLesson"
        />
        <TextInput label="substack" source="substack" />
        <TextInput
        ...
        />
        <TextInput label="Tavus" source="tavus" />
        <TextInput label="TeleRecours" source="teleRecours" />
        <TextInput label="TextMine" source="textMine" />
        <TextInput
        ...
        <TextInput label="Topaz_Photo_AI" source="topazPhotoAi" />
        ...
        />
        <TextInput label="Using_WMIC_Command" source="usingWmicCommand" />
        <TextInput label="WMIC_Command" source="wmicCommand" />
      </SimpleForm>
    </Create>
  );
};
